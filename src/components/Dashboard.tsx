      ...
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center space-x-3">
            <AnchorLogo size={32} className="text-blue-600" />
            <div>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full p-4 rounded-2xl bg-white/80 backdrop-blur-lg border border-white/20 hover:scale-[1.02] shadow-lg hover:shadow-xl transition-all"
          >
            <div className="flex items-center space-x-4">
        ...
        {checkInHistory.length > 0 && (
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-4 border border-white/20">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-gray-900">This Week's Mood</h3>
              ...
              {Array.from({ length: 7 }, (_, i) => {
                ...
                return (
                  <div key={i} className="flex-1 bg-gray-200 rounded h-8 relative overflow-hidden">
                    {dayMood && (
                      <div 
                        className="bg-gradient-to-t from-blue-400 to-blue-500 rounded absolute bottom-0 left-0 right-0 transition-all"
